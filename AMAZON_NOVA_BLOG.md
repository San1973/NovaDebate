# Breaking the Echo Chamber: Building NewsPrism with Amazon Nova Sonic 2
...
This is why we built **NewsPrism**—a revolutionary AI-powered news analysis platform built entirely on **Amazon Web Services (AWS)** and powered by the **Amazon Nova Sonic 2** family of models.
...
### 1. Multi-Agent Orchestration with Amazon Nova Sonic 2
...
*   **The Prism Orchestrator (Nova Sonic 2)**: Cross-references the three outputs to calculate a **Polarization Index** and find the "Shared Reality."

### 2. High-Speed Live Debates
Using **Amazon Bedrock’s** high-throughput inference, our agents engage in a live debating session. We chose **Amazon Nova Sonic 2** (powered by Nova 2 Lite) for the debate logic because its ultra-low latency allows for a fluid, conversational experience that feels human, even when the logic is powered by complex AI.
...
**The future of news isn't a monologue; it's a debate. And with Amazon Nova Sonic 2, that debate is finally fair.**
