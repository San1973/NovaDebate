...
sequenceDiagram
    ...
    participant G as Amazon Nova Sonic 2 API
...
- **Visual Metaphors**: Using **Amazon Nova Sonic 2**, the system generates high-contrast editorial illustrations for each analyst's perspective. This provides a visual anchor for the ideological lens.
...
- **Technology**: **Amazon Nova Sonic 2 TTS**.
...
- **Direct API Integration**: By calling Amazon Nova Sonic 2 from the frontend, we reduce server load and allow for easier scaling of the "Intelligence Log" UI.
