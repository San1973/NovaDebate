# Building NewsPrism: Redefining News with Amazon Nova Sonic 2
...
### The Engine: Amazon Bedrock & Amazon Nova Sonic 2
...
2.  **Real-Time Interaction with Amazon Nova Sonic 2**: This is the "magic" of the project. In our **Live Debate** mode, we use Amazon Nova Sonic 2 (powered by Nova 2 Lite) to facilitate a real-time discussion between our agents. 
    -   **Low Latency**: Nova Sonic 2 allows for near-instantaneous responses.
...
NewsPrism is more than just a tool; it’s an experiment in using AI to promote critical thinking. By combining the reasoning power of **Amazon Nova 2 Pro** with the speed of **Amazon Nova Sonic 2**, we’ve created a platform that doesn't just tell you the news—it talks it through with you.
